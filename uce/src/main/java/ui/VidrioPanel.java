...
public class VidrioPanel extends JPanel {
    private ImagenService imageService;
    private MainView mainView;

    public VidrioPanel(ImagenService service, MainView view) {
        ...
        JButton btnAplicar = new JButton("Aplicar Vidrio");
        ...
        JButton btnHeader = new JButton("▼ VIDRIO ESMERILADO");
        ...
        btnHeader.addActionListener(e -> {
            ...
            btnHeader.setText(visible ? "► VIDRIO ESMERILADO" : "▼ VIDRIO ESMERILADO");
            this.revalidate();
        });

        btnAplicar.addActionListener(e -> {
            BufferedImage resultado = imageService.aplicarVidrioEsmerilado();
            if (resultado != null) {
